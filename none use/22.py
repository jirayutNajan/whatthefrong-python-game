...
###fonts
fonts = font.SysFont(None, 24)
fonts_2 = font.SysFont(None, 50)
#end font
End_font = font.SysFont(None, 120)
end_text = End_font.render('The End', True, (0, 0, 0))
...
End = False
def game():
    global player_rect, enemies_rects, smscroll, boss_rect, End, moving_right, moving_left
    global player_y_momentum, air_timer, boss_Bullets, life, bgsc, middle_x, middle_y, checkpoint_pos
    global step

    #setting
    End = False
    Reaction = False
    player_rect.x = 0 * TILE_SIZE
    player_rect.y = 9 * TILE_SIZE
    ...
    while True: 
        ...
        if player_rect.colliderect(sign_rect[0]):
            ...
            if Reaction:
                font_npc_text = font.SysFont(None, 30)
...
def end_screen():
    ...
    while True:
        ...
        txt_play = fonts_2.render('Play again', True, (0, 35, 23))
        txt_quit = fonts_2.render('Quit', True, (0, 35, 23))
        screen.blit(txt, (200, 115))
        screen.blit(txt_play, (270, 273))
        screen.blit(txt_quit, (330, 360))
        ###
...
def menu():
    ...
    while True:
        ...
        ###text
        txt = End_font.render('WhatTheFrog', True, (4, 27, 13))
        txt_play = fonts_2.render('Play', True, (0, 35, 23))
        txt_quit = fonts_2.render('Quit', True, (0, 35, 23))
        screen.blit(txt, (100, 115))
        screen.blit(txt_play, (330, 270))
        screen.blit(txt_quit, (330, 360))
        ###
